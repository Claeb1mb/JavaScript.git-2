...
1. Describe the biggest difference between `.forEach` & `.map`.
   .foreach calls a function once for each element while .map creates a new array

2. What is the difference between a function and a method?
   functions is a block of code used to perform a task while methods are actions that can be performed on objects.

3) What is closure?
   a closure is a enclosed function in the simplest terms
...
5. Why do we need super() in an extended class?
   We need super() to pass the new attributes back up to the constructor.

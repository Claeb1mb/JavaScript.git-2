...
*/
const displayNames = [];
displayNames.forEach((zooAnimals, index) => {
  alert(zooAnimals.animal_name, zooAnimals.scientific_name, index);
});
...
console.log(lowCaseAnimalNames.toLocaleString());
...
lowPopulationAnimals = zooAnimals.filter(animal_name => {
...
populationTotal = zooAnimals.reduce((population, animal_name) => {
